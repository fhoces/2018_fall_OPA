...
\begin{frame}{Easier Methodological Appraisal. Example: dis-employment effects}
...
\begin{figure}[h!]
\centering
\includegraphics[scale = 0.28]{../Images/sample_pref}
\label{toy_ex}
\end{figure}	
\end{frame}
...
\item Present/showcase your OPA. Pioneers: GiveWell, AEI, CBO.  
...
\medskip
Slides at \\
{\blue \href{https://tinyurl.com/ycfg33vr}{tinyurl.com/yacz2z78}  }
\bigskip \\
...
\subsection{Wages}  
$w':$ wages in 2016 under the status quo.  

\begin{flalign}\label{no_comp}
w^{''} &=
\begin{cases}
w' \quad if \quad  U[0,1]<\alpha_1 \\
w^{new} \quad \quad o/w
\end{cases} &&
\end{flalign}
...
w^{new} &=
\begin{cases}
w'/2 \quad if \quad  w \in U[0,1]<\frac{2\Delta E}{N_{w<MW'}} \\
